...
pub const HEADER_RESERVED_0: usize = 14;
pub const HEADER_RESERVED_1: usize = 15;
...
mod tests {
    ...
    // Old header was 12 floats; new header is 16 floats.
    // Offsets shift by +4, but section sizes stay the same.
    ...
    const OLD_BUFFER_TOTAL_FLOATS: usize = OLD_EVENT_DATA_OFFSET + OLD_EVENT_DATA_FLOATS;
    ...
    fn custom_capacities_compute_correctly() {
        let layout = ProtocolLayout::new(256, 8192, 16, 64);
